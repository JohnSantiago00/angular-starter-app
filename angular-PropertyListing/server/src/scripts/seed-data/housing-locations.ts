...
// Seed-only source data used by `npm run seed`.
// This is not used by runtime API reads, which come from MongoDB.
export const housingLocations: HousingLocationInfo[] = [
  {
    id: 0,
